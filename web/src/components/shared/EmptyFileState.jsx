...
export default function EmptyFileState({ message }) {
  return (
    <div className="card" style={{ padding: 36, textAlign: "center", maxWidth: 540, margin: "0 auto", background: "var(--pbi-surface-alt)" }}>
      <FileSpreadsheet size={52} color="var(--pbi-primary)" style={{ margin: "0 auto 16px" }} />
